...
IPAddress serverIP(192, 168, 0, 3); // SignalR სერვერის ლოკალური IP მისამართი
...
// Reconnect ცვლადები
const unsigned long reconnectDelay = 2000; // ხელახალი დაკავშირების მცდელობა 5 წამში ერთხელ
